...
\textbf{GraphTheory} (a package for graph theory in Wolfram language)\\
\textbf{VertexEnum} (a package for polyhedral operation in Wolfram language)\\
\textbf{SAGEMATH} (an open-source mathematics software system)\\
\textbf{cddml} (cddlib interface to Mathematica via MathLink)\\
\textbf{cddwstp} (cddlib interface to Mathematica via Wolfram Symbolic Transfer Protocol)\\
