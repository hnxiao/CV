...
\EducationEntry{Ph.D. \textmd{in} Combinatorial Optimization}{2011-2016}{University of Hong Kong, Hong Kong}{Supervisors: Prof. Wenan Zang\\
Thesis: Polyhedral methods in combinatorial optimization}
\sepspace

\EducationEntry{M.Sc. \textmd{in} Operations Research}{2008-2011}{Ocean University of China, Qingdao}{Supervisors: Prof. Qizhi Fang\\
Thesis: Algorithms for reliable facility location problem}
\sepspace

\EducationEntry{B.Sc. \textmd{in} Applied Mathematics}{2004-2008}{Ocean University of China, Qingdao}

\NewPart{Academic Experience}{}

\WorkEntry{Senior Research Assistant}{2015-present}{University of Hong Kong, Hong Kong}{}
\WorkEntry{Teaching Assistant}{2011-2015}{University of Hong Kong, Hong Kong}{Courses taught: Matrix theory and its applications; Introduction to mathematical analysis; Linear algebra; Multivariable calculus and linear algebra; Fundamental concepts of mathematics.\newline}

\WorkEntry{Teaching Assistant}{2008-2011}{Ocean University of China, Qingdao}
...
\noindent\textbf{Algorithmic Game Theory}\\
\indent\indent focusing on core solvability.
\vspace{4mm}

\noindent\textbf{Polyhedral Combinatorics}\\
\indent\indent with emphasis on packing and covering in hypergraphs.
\vspace{4mm}

\noindent\textbf{Design and Analysis of Algorithms}\\
\indent\indent mostly arising in the above areas.
...
\NewPart{Academic Memberships}{}
Society for Industrial and Applied Mathematics (SIAM),\\
Association for Computing Machinery (ACM).

\NewPart{References}
%\address{42 Apartment complex}{Street}{City\\Country}
\RefEntry{Prof. Wenan Zang}{University of Hong Kong}{Department of mathematics}{Run Run Shaw Building}{Pokfulam, Hong Kong}{xxxx@maths.hku.hk}{(852) 2856-0000\\}
