...
\newcommand{\EducationEntry}[4]{
		...
		\noindent\hangindent=2em\hangafter=0 #3 \par					% Note
		\iffalse
...
\PersonalEntry{Email}{{xxxxxx@gmail.com}}
...
\NewPart{荣誉与奖项}{}
\WorkEntry{研究生奖学金}{2011-2015}{\textit{香港大学}}
...
\NewPart{源代码贡献}{}
\textbf{GraphSuppl} (基于Wolfram语言的图论工具包)\\
\textbf{SageMath} (基于Python的开源计算机代数系统(CAS))\\
\textbf{mcdd} (C语言函数库cddlib的Mathematica接口)\\
\textbf{VertexEnum} (基于Wolfram语言的凸多面体组合工具包)

\NewPart{References}
%\address{42 Apartment complex}{Street}{City\\Country}
\RefEntry{臧文安教授}{香港大学}{邵逸夫楼}{数学系}{xxxx@maths.hku.hk}{(852) 2856-0000}{}
\rightline{最后更新：\today}
